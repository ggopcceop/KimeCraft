...
public class AuthListener implements Listener {
    ...
    public AuthListener(Auth instance) {
        ...
        loginSQLTask = new LoginSQLTask(addon);
        sessionSQLTask = new SessionSQLTask(addon);

        addon.getPlugin().registerTask(loginSQLTask);
        addon.getPlugin().registerTask(sessionSQLTask);
    }
