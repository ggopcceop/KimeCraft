...
package me.Kime.KC.SQLDataSource;
 ...
 *
 * <p>Home page: <a
 * href="http://www.source-code.biz/miniconnectionpoolmanager">www.source-code.biz/miniconnectionpoolmanager</a><br>
...
public class MiniConnectionPoolManager {
     ...
     * no free connection becomes available within
     ...
     *
     * <p>If a connection is not valid, the method tries to get another
     * connection until one is valid (or a timeout occurs).
     *
     ...
     * <code>Connection</code> objects that have been issued by
     * {@link #getConnection()}, for which
     ...
     *
     * <p>This is the number of internally kept recycled connections, for which
