 ...
 * @author Kime
 */
public class LoadCurrentChannelTask extends Task {

    private final LinkedList<KPlayer> list;
    private final Chat chat;

    public LoadCurrentChannelTask(Chat chat) {
        list = new LinkedList<>();
        this.chat = chat;
    }
    ...
    public void run() {
        ...
        if (player != null) {
            chat.getDataSource().getCurrentChannel(player);
        }
    }
