...
public class PlayerConnection extends Connection {
    ...
    public void sendPacket(Packet packet) {
        if (packet instanceof Packet3Chat) {
            ...
            for (final String line : org.bukkit.craftbukkit.v1_4_R1.TextWrapper.wrapText(message)) {
    ...
    public void a(Packet130UpdateSign packet130updatesign) {
        ...
        if (worldserver.isLoaded(packet130updatesign.x, packet130updatesign.y, packet130updatesign.z)) {
            ...
            if (tileentity instanceof TileEntitySign) {
                ...
                SignChangeEvent event = new SignChangeEvent((org.bukkit.craftbukkit.v1_4_R1.block.CraftBlock) player.getWorld().getBlockAt(j, k, i), this.server.getPlayer(this.player), packet130updatesign.lines);
                this.server.getPluginManager().callEvent(event);
